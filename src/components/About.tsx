    ...
    <section id="om" className="px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-3xl">
        <ScrollFadeIn direction="scale">
          <div className="rounded-2xl border border-white/5 bg-gray-900/50 p-8 transition-all duration-300 hover:border-white/10 sm:p-12">
            ...
            <div className="mt-6 space-y-4 leading-relaxed text-gray-400">
              ...
              <p>
                ...
                fordel med de rigtige AI-værktøjer. Og jeg gør det nemt for dig
                at komme i gang.
              </p>
            </div>
          </div>
