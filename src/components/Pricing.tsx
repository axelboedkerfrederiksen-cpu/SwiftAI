    ...
    <section id="pakker" className="px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          {plans.map((plan, i) => (
            <ScrollFadeIn key={plan.name} delay={i * 120} direction="scale">
              <div
                className={`relative h-full rounded-2xl border p-8 transition-all duration-300 ${
                  plan.popular
                    ...
                    : "border-white/5 bg-gray-900/50 hover:-translate-y-1 hover:border-white/10 hover:shadow-xl hover:shadow-black/20"
                }`}
              >
                {plan.popular && (
